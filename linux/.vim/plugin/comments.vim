...
noremap  <silent> \cc :call CommentLine()<CR>
noremap  <silent> <c-c> :call CommentLine()<CR>
" key-mappings for range comment lines in visual <Shift-V> mode
vnoremap <silent>  \cc :call RangeCommentLine()<CR>
vnoremap <silent>  <c-c> :call RangeCommentLine()<CR>

" key-mappings for un-comment line in normal mode
noremap  <silent> \co :call UnCommentLine()<CR>
noremap  <silent> <c-x> :call UnCommentLine()<CR>
" key-mappings for range un-comment lines in visual <Shift-V> mode
vnoremap <silent> \co :call RangeUnCommentLine()<CR>
