...
vnoremap    <buffer>  <silent>  <LocalLeader>co    <Esc>:call C_CommentCode("v")<CR>:nohlsearch<CR>
 ...
 noremap    <buffer>  <silent>  <LocalLeader>cb        :call C_InsertTemplate("comment.frame")<CR>
 noremap    <buffer>  <silent>  <LocalLeader>cf        :call C_InsertTemplate("comment.function")<CR>
...
noremap    <buffer>  <silent>  <LocalLeader>dg		:call C_InsertTemplate("comment.defgroup")<cr>
noremap    <buffer>  <silent>  <LocalLeader>ag		:call C_InsertTemplate("comment.addtogroup")<cr>
noremap    <buffer>  <silent>  <LocalLeader>ig		:call C_InsertTemplate("comment.ingroup")<cr>
noremap    <buffer>  <silent>  <LocalLeader>mg		:call C_InsertTemplate("comment.membergroup")<cr>

inoremap    <buffer>  <silent>  <LocalLeader>cb   <Esc>:call C_InsertTemplate("comment.frame")<CR>
inoremap    <buffer>  <silent>  <LocalLeader>cf   <Esc>:call C_InsertTemplate("comment.function")<CR>
...
inoremap    <buffer>  <silent>  <LocalLeader>dg    <Esc>:call C_InsertTemplate("comment.defgroup")<cr>
inoremap    <buffer>  <silent>  <LocalLeader>ag	   <Esc>:call C_InsertTemplate("comment.addtogroup")<cr>
inoremap    <buffer>  <silent>  <LocalLeader>ig	   <Esc>:call C_InsertTemplate("comment.ingroup")<cr>
inoremap    <buffer>  <silent>  <LocalLeader>mg	   <Esc>:call C_InsertTemplate("comment.membergroup")<cr>
...
inoremap    <buffer>  <silent>  <LocalLeader>sd    <Esc>:call C_InsertTemplate("statements.do-while")<CR>
 ...
 noremap    <buffer>  <silent>  <LocalLeader>sf        :call C_InsertTemplate("statements.for-block")<CR>
vnoremap    <buffer>  <silent>  <LocalLeader>sf   <Esc>:call C_InsertTemplate("statements.for-block", "v")<CR>
inoremap    <buffer>  <silent>  <LocalLeader>sf   <Esc>:call C_InsertTemplate("statements.for-block")<CR>


 noremap    <buffer>  <silent>  <LocalLeader>si        :call C_InsertTemplate("statements.if-block")<CR>
vnoremap    <buffer>  <silent>  <LocalLeader>si   <Esc>:call C_InsertTemplate("statements.if-block", "v")<CR>
inoremap    <buffer>  <silent>  <LocalLeader>si   <Esc>:call C_InsertTemplate("statements.if-block")<CR>
...
inoremap    <buffer>  <silent>  <LocalLeader>sife  <Esc>:call C_InsertTemplate("statements.if-block-else")<CR>
 ...
 noremap    <buffer>  <silent>  <LocalLeader>sw        :call C_InsertTemplate("statements.while-block")<CR>
vnoremap    <buffer>  <silent>  <LocalLeader>sw   <Esc>:call C_InsertTemplate("statements.while-block", "v")<CR>
inoremap    <buffer>  <silent>  <LocalLeader>sw   <Esc>:call C_InsertTemplate("statements.while-block")<CR>
